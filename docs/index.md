...
**IRL Lens, inside each domain:** personal focus areas and deep dives are explicitly labeled (★ Focus Area) rather than silently shaping the hierarchy, and each domain links out to relevant case studies rather than duplicating them.

**Landscape, as each domain's final section:** open questions, trends, and expertise leads — scoped to that domain specifically, not a generic top-10 list living elsewhere.
